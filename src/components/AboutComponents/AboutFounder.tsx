    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center px-5">
        <div>
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-6">
            I’m incredibly proud of our achievements and grateful for the trust of our clients. We’re
            excited to continue this journey with you — offering innovative services and unforgettable
            experiences.
          </p>
